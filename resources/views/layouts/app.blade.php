...
<head>
    ...
    <title>{{ config('app.name', 'Shule Chap') }}</title>

    <link rel="icon" href="{{ asset('images/iconWhite.png') }}" type="image/x-icon" />
...
<body class="vertical light">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <div class="footer bg-transparent mt-5">
                                <div class="d-flex float-right">
                                    <div class="copyright">
                                        <p>Powered by <a href="#" target="_blank">soscom</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        if ($('#dataTable-1').length && $.fn.DataTable) {
